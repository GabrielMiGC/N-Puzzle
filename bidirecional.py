...
def bidirecional():
    ...
    iteracoes = 0
    nos_expandidos = 0
    while len(lista_aberta_init) > 0 and len(lista_aberta_final) > 0:
        iteracoes += 1
        ...
        if intersec(lista_aberta_init, lista_aberta_final):
            print("Quantidade de nos expandidos: ", nos_expandidos)
            print("\nMedia de nos: ", nos_expandidos//iteracoes)
